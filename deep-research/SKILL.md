...
- Resolve paths relative to this skill folder. If a path starts with `deep-research/`, strip that prefix. Shared resources referenced as `shared/...` are bundled inside this skill.
