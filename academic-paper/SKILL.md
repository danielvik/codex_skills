...
- Resolve paths relative to this skill folder. If a path starts with `academic-paper/`, strip that prefix. Shared resources referenced as `shared/...` are bundled inside this skill.
- Sibling skill paths such as `deep-research/...`, `academic-paper-reviewer/...`, or `academic-pipeline/...` require installing the migrated sibling skills together.
