...
- Wrapper: not bundled in this Codex migration. If this gate is required, use an explicitly reviewed external audit wrapper and keep it opt-in; do not assume `scripts/run_codex_audit.sh` exists in this skill.
